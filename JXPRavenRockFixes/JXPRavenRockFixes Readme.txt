                           JESSIE's RAVEN ROCK FIXES
                              1.1.0, February 2025

                                   1. LEGAL

Copyright © 2022, 2025 Jessie Kirk [https://jessiekirk.xyz/]
...
see [http://www.wtfpl.net/about/].
    ...
    1. Review the “JXPRavenRockFixes License.txt” file to ensure you understand
       your rights.

    2. Extract the file “JXPRavenRockFixes.esp” from the archive file
       “JXPRavenRockFixes.zip” to your PC's Fallout 3 Data directory. The usual
    ...
    3. Optionally, extract the files “JXPRavenRockFixes Readme.txt” and
       “JXPRavenRockFixes License.txt” to your PC's Fallout 3 Data
    ...
    4. Launch Fallout 3. When the Launcher window appears, select Data Files.
       ...
       Click/tap the checkbox next to “JXPRavenRockFixes.esp” to enable
       it, then click/tap the OK button. The mod is now installed.

                                3. GAME CHANGES

    This mod adds eyebots and empty lockers to all of Raven Rock's holding
    cells.

    NOTE: This mod used to be called Jessie's Raven Rock Holding Cells Mod.

                                 4. RATIONALE

    In Raven Rock - Level 3, there doesn't seem to be anything special about
    the player's holding cell; yet it's the only one of the 6 jails with wall-
    mounted eyebots, and the only one with a locker.

                        5. UNINSTALLATION INSTRUCTIONS

    1. Delete the file “JXPRavenRockFixes.esp”. The mod is now uninstalled.

                                 6. CHANGELOG

    0.1.0
      Initial commit.
      Added 10 new eyebots and 5 empty Enclave lockers to all Raven Rock -
    ...
    1.1.0
      Overhauled Eyebot Intercom references.
      Changed mod name to match newer ones.
