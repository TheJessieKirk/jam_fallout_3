                       JESSIE'S ESSENTIAL EVAN KING MOD
                              0.1.0, February 2025
...
see [http://www.wtfpl.net/about/].
    ...
    1. Review the “JXPEssentialEvanKing License.txt” file to ensure you
       understand your rights.

    2. Extract the file “JXPEssentialEvanKing.esp” from the archive file
       “JXPEssentialEvanKing.zip” to your PC's Fallout 3 Data directory. The
    ...
    3. Optionally, extract the files “JXPEssentialEvanKing Readme.txt” and
       “JXPEssentialEvanKing License.txt” to your PC's Fallout 3 Data directory
    ...
    4. Launch Fallout 3. When the Launcher window appears, select “Data Files”.
       ...
       Click/tap the checkbox next to “JXPEssentialEvanKing.esp” to enable it,
       then click/tap the “OK” button. The mod is now installed.

                                3. GAME CHANGES

    Makes Evan King essential (unkillable).

                                 4. RATIONALE

    I have no rationale. I'm a big squish and don't want Evan to die.

                        5. UNINSTALLATION INSTRUCTIONS

    1. Delete the file “JXPEssentialEvanKing.esp”. The mod is now uninstalled.

                                 6. CHANGELOG

    0.1.0
      Initial commit.
      Added "essential" flag to Evan King NPC.

                                  7. CREDITS

    Made upon request for LittlePunisher.
