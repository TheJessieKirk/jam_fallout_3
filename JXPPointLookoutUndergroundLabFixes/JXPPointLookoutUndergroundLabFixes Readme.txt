...
see [http://www.wtfpl.net/about/].
    ...
    1. Review the “JXPPointLookoutUndergroundLabFixes License.txt” file to
       ensure you understand your rights.

    2. Extract the file “JXPPointLookoutUndergroundLabFixes.esp” from the
       archive file “JXPPointLookoutUndergroundLabFixes.zip” to your PC's
    ...
    3. Optionally, extract the files “JXPPointLookoutUndergroundLabFixes
       Readme.txt“ and “JXPPointLookoutUndergroundLabFixes License.txt” to your
    ...
    4. Launch Fallout 3. When the Launcher window appears, select “Data Files”.
       ...
       Click/tap the checkbox next to “JXPPointLookoutUndergroundLabFixes.esp”
    ...
    “Naval Cots” are now called “Cots” instead.

                                 4. RATIONALE

    They're probably called “Naval Cots” because they were just reused from
    Rivet City; the Underground Lab is probably not a US Navy facility.

                        5. UNINSTALLATION INSTRUCTIONS

    1. Delete the file “JXPPointLookoutUndergroundLabFixes.esp”. The mod is now
       uninstalled.
    ...
    0.1.0
      Initial commit.
      Replaced all Navy Cots with new Cots.
