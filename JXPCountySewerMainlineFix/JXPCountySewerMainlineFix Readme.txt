                       JESSIE's COUNTY SEWER MAINLINE FIX
                              0.1.0, February 2025
...
see [http://www.wtfpl.net/about/].
    ...
    1. Review the “JXPCountySewerMainlineFix License.txt” file to ensure you
       understand your rights.

    2. Extract the file “JXPCountySewerMainlineFix.esp” from the archive file
       “JXPCountySewerMainlineFix.zip” to your PC's Fallout 3 Data directory.
    ...
    3. Optionally, extract the files “JXPCountySewerMainlineFix Readme.txt” and
       “JXPCountySewerMainlineFix License.txt” to your PC's Fallout 3 Data
    ...
    4. Launch Fallout 3. When the Launcher window appears, select “Data Files”.
       ...
       Click/tap the checkbox next to “JXPCountySewerMainlineFix.esp”
       to enable it, then click/tap the “OK” button. The mod is now installed.

                                3. GAME CHANGES

    Fixes an issue where it's really difficult to get out of the water if you
    fall in.
    ...
    In the depths of the County Sewer Mainline, there is a pit full of water.
    If you fall in, it's possible, but quite difficult, to get out of the pool.
    Your only hope is to try to awkwardly purch yourself onto a beam, move
    along it, then try to hop out. This is poor level design.

    Now there's some stairs.

                        5. UNINSTALLATION INSTRUCTIONS

    1. Delete the file “JXPCountySewerMainlineFix.esp”. The mod is now
       uninstalled.
    ...
    0.1.0
      Initial commit.
      Added stairs to the edge of the pool.
