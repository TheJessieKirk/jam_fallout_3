...
see [http://www.wtfpl.net/about/].
    ...
    It can be be used to repair, and be repaired with, Scoped .44 Magnums,
    and used to repair Blackhawk.

    With the Mothership Zeta compatibility Patch (“JXP44MagnumZetaCP.esp”), it
    can also be used to repair Paulson's Revolver.

    NOTE: If you upgrade from any previous version prior to 0.2.0, any
    ...
    Since it's perfectly lore-friendly it seems a suitable addition to the base
    game.
    ...
    [https://www.nexusmods.com/oblivion/mods/8698/]
