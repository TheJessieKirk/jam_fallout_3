...
see <http://www.wtfpl.net/about/>.
    ...
    2. Extract the file “JXPEssentialReillysRangers.esp” from the archive file
       JXPEssentialReillysRangers.zip” to your PC's Fallout 3 Data directory.
    ...
    4. Launch Fallout 3. When the Launcher window appears, select “Data Files”.
       ...
       Click/tap the checkbox next to “JXPEssentialReillysRangers.esp” to
       enable it, then click/tap the “OK” button. The mod is now installed.

                                3. GAME CHANGES

    Makes all members of Reilly's Rangers essential (unkillable), except the
    late Theo.

                                 4. RATIONALE

    I have no rationale. I'm a big squish and don't want the Rangers to die.

                        5. UNINSTALLATION INSTRUCTIONS

    1. Delete the files “JXPEssentialReillysRangers.esp”. The mod is now
       uninstalled.
